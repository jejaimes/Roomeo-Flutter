...
class Classroom {
  ...
  Classroom(int number, int maxCap, int currentCap, String building) {
    this.number = number;
    this.maxCap = maxCap;
...
class Building {
  ...
  Building(int capacity, String name, List<Classroom> classrooms) {
      ...
      builder:
        ...
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          for (var item in data) {
            Classroom room = Classroom(item['number'], item['maxCap'],
                item['currentCap'], widget.building!);
            _classroms.add(room);
          }
          print(_classroms);
          return Scaffold(
